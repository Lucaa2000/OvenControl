...
#program to check if subscription works
...
def on_message(client, userdata, message): #define what is done when message is received
...
def on_connect(client, userdata, flags, rc): #define what is done when mqtt connected
